...
<div class="container mx-auto p-4">
    ...
    <a href="{{ route('supplier.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block hover:bg-blue-600">Tambah Supplier</a>
        ...
        <tbody>
            @forelse ($suppliers as $supplier)
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $supplier->kode_pos }}</td>
                    <td class="border px-4 py-2">
                        <a href="{{ route('supplier.edit', $supplier) }}" class="bg-yellow-500 text-white px-2 py-1 rounded mr-2 hover:bg-yellow-600">Edit</a>
